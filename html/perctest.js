...
var mypvtid = null;
// We use the following shared key for PERC
var percKey = "MTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5MDEyMzQ=";
						...
						janus.attach(
							{
								...
								opaqueId: opaqueId,
								percLite: true,		// We need to tell Janus this will be a PERC-enabled handle
								success: function(pluginHandle) {
									$('#details').remove();
									sfutest = pluginHandle;
									Janus.log("Plugin attached! (" + sfutest.getPlugin() + ", id=" + sfutest.getId() + ")");
									Janus.log("  -- This is a publisher/manager");
									// Let's specify the PERC key we'll use
										...
										if(event === "joined") {
											...
											if(msg["publishers"] !== undefined && msg["publishers"] !== null) {
												...
												if(msg["error_code"] === 426) {
													...
													bootbox.alert(
														"<p>Apparently room <code>" + myroom + "</code> (the one this demo uses for testing PERC) " +
								...
								onlocalstream: function(stream) {
									...
									$('#publisher').removeClass('hide').html('<i class="fa fa-lock fa-fw"></i> ' + myusername).show();
			...
			onmessage: function(msg, jsep) {
				...
				if(event != undefined && event != null) {
					if(event === "attached") {
						...
						$('#remote'+remoteFeed.rfindex).removeClass('hide').html('<i class="fa fa-lock fa-fw"></i> ' + remoteFeed.rfdisplay).show();
					} else if(msg["error"] !== undefined && msg["error"] !== null) {
						bootbox.alert(msg["error"]);
					} else {
