...
shared GList *janus_auth_list_tokens(void);
/*! \brief Method to invalidate an existing token
 * @param[in] token The valid to invalidate
 * @returns true if the operation was successful, false otherwise */
shared gboolean janus_auth_remove_token(const char *token);
 ...
 * @returns true if the operation was successful, false otherwise */
shared gboolean janus_auth_allow_plugin(const char *token, void *plugin);
...
shared gboolean janus_auth_check_plugin(const char *token, void *plugin);
...
shared GList *janus_auth_list_plugins(const char *token);
 ...
 * @returns true if the operation was successful, false otherwise */
shared gboolean janus_auth_disallow_plugin(const char *token, void *plugin);
