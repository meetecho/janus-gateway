 ...
 * \c play_file , \c is_playing, \c stop_file and \c stop_all_files are synchronous requests,
 ...
 * still playing, while \c stop_file and \c stop_all_files will stop such a playback instead.
 *
