...
void janus_turnrest_set_backend(const char *server, const char *key, const char *method, const uint timeout, const gboolean tls_verify_host) {
	janus_mutex_lock(&api_mutex);
