...
static struct janus_json_parameter create_parameters[] = {
	...
	{"sampling_rate", JANUS_JSON_INTEGER, JANUS_JSON_PARAM_POSITIVE},
	{"sampling", JANUS_JSON_INTEGER, JANUS_JSON_PARAM_POSITIVE},	/* We keep this to be backwards compatible */
