...
JANUS_API janus_recorder *janus_recorder_create(const char *dir, const char *codec, const char *filename);
...
JANUS_API int janus_recorder_save_frame(janus_recorder *recorder, char *buffer, uint length);
/*! \brief Close the recorder
 * @param[in] recorder The janus_recorder instance to close
 * @returns 0 in case of success, a negative integer otherwise */
JANUS_API int janus_recorder_close(janus_recorder *recorder);
/*! \brief Free the recorder resources
 * @param[in] recorder The janus_recorder instance to free
 * @returns 0 in case of success, a negative integer otherwise */
JANUS_API int janus_recorder_free(janus_recorder *recorder);
